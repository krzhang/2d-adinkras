...
The notion of $2$-d Adinkras is described in \com{Ref...[fill in references to various things]}.  We use a definition here that is equivalent to the one found in \com{[some reference]}: the proof is found in Appendix \com{...[maybe?]}
...
\caption{A $2$-d Adinkra with $(2,2)$ colors. The bigrading is visualized by the northwest and northeast directions, respectively. \label{fig:2d-example}}
\end{center}
\end{figure}
...
\Vertex[x=30,y=80]{AB}
\Vertex[x=40,y=80]{BB}
\Vertex[x=10,y=120]{EB}
\Vertex[x=20,y=120]{FB}
\Vertex[x=20,y=35]{BF}
\Vertex[x=10,y=35]{BE}
