...
\item $\mu:E\to \ZZ_2=\{0,1\}$ is a map called the \emph{dashing},\footnote{As is common in the literature, when we draw a graph, we draw a dashed edge if $\mu(e)=1$ and a solid edge if $\mu(e)=0$.}
