...
\begin{abstract}
Adinkras are combinatorial objects developed to study supersymmetry representations.  Adinkras that describe $2$-dimensional supersymmetry are called \emph{$2$-d Adinkras}.  We prove a conjecture of T. H\"ubsch, thereby describing a classification of all $2$-d Adinkras. \com{For advertising / diversity of content purposes, why not mention something about codes? maybe something like ``continuing with the tradition of understanding Adinkras through coding theory, we also classify the doubly even codes that appear when studying $2$-d Adinkras.''?}
\end{abstract}
