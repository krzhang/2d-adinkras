...
\begin{abstract}
Adinkras are combinatorial objects developed to study supersymmetry representations.  Adinkras that describe $2$-dimensional supersymmetry are called \emph{$2$-d Adinkras}.  We prove a conjecture of T. H\"ubsch, thereby describing a classification of all $2$-d Adinkras.  Along the way, we obtain other structural results, including a simple characterization of H\"ubsch's \emph{even-split doubly even codes}. As we focus on the combinatorics of Adinkras, no specialist background knowledge is required.
\end{abstract}
