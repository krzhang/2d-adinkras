...
\caption{The graphs $I^4$ and $G = I^4/\{0000,1111\}$. As the code $\{000, 1111\}$ is doubly-even, there exists an Adinkra with $G$ as its underlying graph. \label{fig:4cube folding}}
\end{center}
\end{figure}
...
\Edge[color=green](010000)(001100)
\Edge[color=green](011000)(000100)
\end{tikzpicture} & \begin{tikzpicture}[scale=0.1]
\SetVertexSimple[MinSize=5pt]
\SetUpEdge[labelstyle={draw}]
\Vertex[x=0,y=0]{000000}
\Vertex[x=10,y=0]{001100}
