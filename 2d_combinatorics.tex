...
Encoded within the proof of this theorem is the fact that if $C$ is a doubly-even code, then there exists an admissable dashing. A constructive proof of existence can be found in \cite{d2l:topology}. See \cite{zhang:adinkras} for an enumeration of all admissable dashings for any doubly-even code.
