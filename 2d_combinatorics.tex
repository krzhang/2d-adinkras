...
Note that the bottom square shows that $\tilde{\Phi}$ is an isomorphism.

\com{Here's my take, with xymatrix. If you like this, then replace the thing above with it / edit as you wish. Note I only made one of them a bijection arrow -- either remove or replace all isomorphisms with the bijection arrows at your liking. -Y}
\[
\xymatrixcolsep{5pc}
\xymatrix{
